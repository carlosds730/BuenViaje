...
class SubscriptionAdmin(admin.ModelAdmin, ExtendibleModelAdminMixin):
    ...
    exclude = ['unsubscribed', 'unsubscribe_date', 'activation_code']
    ...
    make_subscribed.short_description = _("suscribir a los usuarios seleccionados")
    ...
    make_unsubscribed.short_description = _("dar de baja a los usuarios seleccionados")
